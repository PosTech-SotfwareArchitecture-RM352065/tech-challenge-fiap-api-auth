...
module "github" {
  ...
  sanduba_customer_topic_manager_connection_string   = module.sanduba_customer_topic_manager_connection_string
  sanduba_customer_topic_publisher_connection_string = module.sanduba_customer_topic_publisher_connection_string
  sanduba_customer_topic_listener_connection_string  = module.sanduba_customer_topic_listener_connection_string
